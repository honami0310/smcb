...
$view .= '</td>';
    ...
    if ($res["requestid"] == $_SESSION["personalid"]) {
      $view .= '<td><a href="evaluate_smcb.php? id=' . h($res["id"]) . '">[SMBの結果を入力]</a></td>';
  }else{
    $view .= '<td></td>' ;}
  if ($res["onoroff"] == '知恵袋'){
...
<head>
  ...
  <title>Share MC Brain User 一覧</title>
  <!-- <link rel="stylesheet" href="css/style.css"> -->
  <style>
    div {
      padding: 10px;
...
<body id="main">
  ...
  <div id="mypage_header">
    <div class="mypagehead"><h3>SMCB 一覧</h3></div>
  ...
  <div class="left">
    ...
    <div>
    <form action="smcb_list.php" method="post">
  ...
  <div>
    <form action="smcb_list.php" method="get">
  ...
  <div><button><a href="smcb_list.php">すべて表示</a></button></div>
